...
{
  public partial class Muliply : Form
    {
        ...
        private void Muliply_Load(object sender, EventArgs e)
        {
            generateNumbers();
        }
        ...
        private void Muliply_FormClosing(object sender, FormClosingEventArgs e)
        {
